...
export class LiveStream {
    ...
    constructor(pubkeyOrName) {
        if (pubkeyOrName.startsWith('local_') || pubkeyOrName.startsWith('remote_')) {
            this.id = pubkeyOrName.replace('local_', '').replace('remote_', '');
    ...
    async start() {
        ...
        const nostrEvent = {
            ...
            "tags": [
                ...
                ["p", this.pubkey, "wss://relay.zap.stream", "host"],
